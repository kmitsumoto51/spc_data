...
const double T_start = 0.37;
const double T_finish = 0.0;
const int ave_t = 10000;
const int time_in = 275;
...
int main(int argc, char **argv){
  ...
  << (int)((T+0.00001)*10000) << "_" << step1 << "_" << time_in << "_" << seed << "_heat_dynamics.txt";
  ...
  << (int)((T+0.00001)*10000) << "_" << step1 << "_" << time_in << "_" << seed << "_heat_dyna_d_noise.txt";
