...
const double mu_start = -0.5;
const double mu_finish = -1.5;
...
int main(int argc, char **argv){
  ...
  stringstream name1;
  name1 << "eq_physical" << "/" << L 
  << "_" << T_in << "_" << Pre_in << "_" << alpha_in << "_" << k_in << "_" << step1 << "_" << seed << "_both_negative_mu_down.txt";
  ...
  while(mu > mu_finish+0.00001){
    ...
    fstream f4;
    stringstream name4;
    name4 << "conf" << "/" << L << "_" << (int)((-mu+0.00001)*1000) << "_" << Pre_in << "_" << alpha_in << "_" << k_in << "_"
    << T_in << "_" << step1 << "_" << seed << "_both_negative_mu_down.txt";
